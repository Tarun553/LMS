...
export default function Globe1() {
  return (
    <>
      <div
        className="bg-background flex flex-col items-center justify-center overflow-hidden">
        <article
          className="border-border relative mx-auto my-8 max-w-[500px] rounded-xl border p-5 text-center">
